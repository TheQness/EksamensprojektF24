...
public static class Extensions //does not inheret from MonoBehavior
{
    ...
    public static bool Raycast(this Rigidbody2D rigidBody, Vector2 direction, float distance = 0.375f) //returns a bool. defines an extension method named Raycast for objects of type Rigidbody2D
    {
